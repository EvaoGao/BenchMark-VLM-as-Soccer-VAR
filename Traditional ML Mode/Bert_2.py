...
JSON_H1 = REPO_ROOT / "complete_consistent_data.json"  # Head-1: Foul
JSON_H23 = REPO_ROOT / "fouls_data.json"               # Head-2/3: Card & Advantage
...
def _run_one_head(head_name: str, data_path: Path, device: str):
    ...
    cache_path = CACHE_DIR / f"videomae_emb_cache_{head_name}.npz"

    E = compute_embeddings(
        df, FRAMES_ROOT, cache_path, PRETRAINED, device,
        NUM_FRAMES, MAX_IMGS,
